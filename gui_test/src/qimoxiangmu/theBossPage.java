/*
 * Created by JFormDesigner on Fri Mar 24 11:05:49 CST 2023
 */
 ...
 * @author 86155
 */
public class theBossPage extends JFrame {
    public theBossPage(String a) {
        initComponents(a);
    }
...
*/
    ...
    private void initComponents(String a) {
        ...
        ((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {25, 41, 32, 23, 34, 34, 34, 34, 34, 35, 0};
        ...
        //======== panel1 ========
        {
            ...
            ((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {23, 133, 0};
            ...
            //---- manageset ----
            manageset.setText(bundle.getString("manageset.text_4"));
            manageset.setFont(new Font("\u6977\u4f53", Font.BOLD, 16));
            manageset.setBorderPainted(false);
            manageset.addActionListener(e -> manageset(e));
            panel1.add(manageset, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        ...
        contentPane.add(panel3, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.VERTICAL,
            new Insets(0, 0, 5, 5), 0, 0));
        ...
        contentPane.add(panel5, new GridBagConstraints(1, 8, 1, 1, 0.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.VERTICAL,
            new Insets(0, 0, 5, 5), 0, 0));
        pack();
